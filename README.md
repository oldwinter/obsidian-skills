...
```sh
git clone https://github.com/oldwinter/obsidian-skills.git ~/.opencode/skills/obsidian-skills
```
...
| [knap](skills/knap)                           | 使用 [Knap](https://github.com/obsidianmd/knap) 从 JSON 或 CSV 数据渲染 Markdown 模板，包括批量生成文件                                                          |
